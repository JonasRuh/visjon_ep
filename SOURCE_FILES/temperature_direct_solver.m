...
if shear_heat == 1
    RT(kT_ind)       =   RT(kT_ind) - (Txx(kT_ind).^2./eta_p(kT_ind) + Txy(kT_ind-(ny+1)-1).^2./(4.*eta_s(kT_ind-(ny+1)-1)) + Txy(kT_ind-(ny+1)).^2./(4.*eta_s(kT_ind-(ny+1))) + Txy(kT_ind).^2./(4.*eta_s(kT_ind)) + Txy(kT_ind-1).^2./(4.*eta_s(kT_ind-1)));
end
if ra_heat == 1
